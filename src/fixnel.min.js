...
hide:function(){this.inner.style.display="none"},_renderShow:function(){this._show();this._wait(2E3)},getEl:function(){return this.el},_getContentInfo:function(){this._minSize=this._getMinSize();this.container=this.fl.getContainer();this.contentSize=this.fl.getSize();this.containerSize=this.fl.getParentSize();this.scrollSize=this.contentSize-this.containerSize;this.ratio=this.containerSize/this.contentSize},_getMinSize:function(){throw Error("MUST BE IMPLEMENTS THIS METHOD");},_setPos:function(){throw Error("MUST BE IMPLEMENTS THIS METHOD");
},_setSize:function(){throw Error("MUST BE IMPLEMENTS THIS METHOD");},_setElSize:function(){throw Error("MUST BE IMPLEMENTS THIS METHOD");},_setInitSize:function(){var a=this.containerSize*this.ratio|0;if(!a)return false;if(a<this._minSize)a=this._minSize;this.size=a;this._setSize(a);this._setElSize(a)},_setSizeStart:function(a){a=(this.containerSize*this.ratio|0)-a/2;this._setPosOriginStart();this._setPos(0);this._setSize(a)},_setSizeEnd:function(a){a=(this.containerSize*this.ratio|0)+(a+this.scrollSize)/
2;this._setPosOriginEnd();this._setPos(-this.scrollSize);this._setSize(a)},_setPosOriginStart:function(){throw Error("MUST BE IMPLEMENTS THIS METHOD");},_setPosOriginEnd:function(){throw Error("MUST BE IMPLEMENTS THIS METHOD");},_move:function(a,b){var c=b.value;if(c>0)this._setSizeStart(c);else if(c<-this.scrollSize)this._setSizeEnd(c);else if(c===null)return this.trigger("moveend"),false;else this._setPos(c)},_moveStart:function(){clearTimeout(this.timer);if(this.moving||this.timer)return false;
this.timer=null;this.moving=true;this._show()},_moveEnd:function(){this._wait(300);this.moving=false},_wait:function(a){this._fader.delayFadeOut(a)},_hide:function(){this._fader.fadeOut()},_show:function(){this._fader.fadeIn()},_createElement:function(){throw Error("MUST BE IMPLEMENTS THIS METHOD");},_update:function(){this._getContentInfo();this._setInitSize();this._setPos(this._pos);this._renderShow()}});var I=n.extend({_getMinSize:function(){return+(this.el.style.width||"").replace("px","")},_setPos:function(a){if(!a)return false;
