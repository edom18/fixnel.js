...
h.mode.NOT_FADE},delayFadeOut:function(a){var b=this;a||(a=h.DEFAULT_DELAY);clearTimeout(this.waitTimer);this.waitTimer=setTimeout(function(){b.waitTimer=null;if(b._getOpacity()===0)return false;b.fadeOut()},a)},_getOpacity:function(){return this.target.style.opacity},_setOpacity:function(a){if(!a)return false;this.target.style.opacity=a}};y.prototype=o({},l.prototype,{FPS:1E3/60,DURATION:30,Easing:k,init:function(a){this.fl=a;this._createElement();this._getContentInfo();this._setInitSize();this._fader=
...
this._setPos(this._pos);this._renderShow()}});z.prototype=o({},l.prototype,{FPS:1E3/60,DURATION:30,Easing:k,init:function(a){this.fl=a;this._createElement();this._getContentInfo();this._setInitSize();this._fader=new h(this);this.fl.on("update",this._update,this);this.fl.on("move",this._move,this);this.fl.on("movestart",this._moveStart,this);this.fl.on("moveend",this._moveEnd,this);this.render()},render:function(){this.container.appendChild(this.el);this._renderShow();return this},_renderShow:function(){this._show();
...
b,c,d){return-c*(a/=d)*(a-2)+b},easeInOutQuad:function(a,b,c,d){return(a/=d/2)<1?c/2*a*a+b:-c/2*(--a*(a-2)-1)+b}},getValue:function(){return this.t>this.d?null:this.timingFunction(this.t++,this.b,this.c,this.d)}};m.directionType={VERTICAL:"vertical",HORIZONTAL:"horizontal",BOTH:"both"};m.prototype={init:function(a,b){b||(b={});b.direction===m.directionType.BOTH?(this._vfixnel=new s(a),this._hfixnel=new t(a)):b.direction===m.directionType.HORIZONTAL?this._hfixnel=new t(a):this._vfixnel=new s(a)}};
s.prototype=o({},l.prototype,{dragging:false,DURATION:30,FPS:1E3/60,prevAccY:0,prevY:0,prevT:0,accY:0,vy:0,y:0,init:function(a){this.el=a;this.parentEl=a.parentNode;this.Easing=k;this.el.originalHeight=this.getHeight();this._initSettings();this._checkHeight();this.scrollbar=new y(this);a.className+=a.className?" fixnel-body":"fixnel-body";a.addEventListener(p,i(this._down,this),false);a.addEventListener(p,i(this._stop,this),false);n.addEventListener(B,i(this._up,this),false);n.addEventListener(A,
i(this._move,this),false);x.addEventListener("resize",i(this.update,this),false)},moveTo:function(a,b){var c=this,d,e,f;b||(b={});if(a===0||a){a*=-1;if(a>0)a=0;else if(a<(d=-this._getBottom()))a=d;if(b.animOff)return this._setY(a),false;d=this._getY();e=new this.Easing("easeOutExpo",0,d,a-d,10);this._autoMoving=true;(function w(){var b=e.getValue();if(b===null)return e=null,clearTimeout(f),c._setY(a),c._autoMoving=false,null;c._setY(b);f=setTimeout(w,16)})()}},getValue:function(){var a,b,c=0,d=0,
d=this.DURATION,e=this.vy;a=0;if(this.bouncing){a=this.bounce.getValue();return a===null?(this._stopScrolling(),null):a|0}a=this._getY();if(C(e)<=0)if(a>0)c=a|0,this.bounce=new this.Easing("easeOutExpo",0,c,0-c,d),this.bouncing=true;else if(a<(b=-this._getBottom()))c=a|0,this.bounce=new this.Easing("easeOutExpo",0,c,b-c,d),this.bouncing=true;else return this._stopScrolling(),null;if(a+e>0)this.vy=e>10?10:e;if(a-e<-this._getBottom())this.vy=e<-10?-10:e;return a=a+this.getVY()|0},_initSettings:function(){this.el.style.webkitTextSizeAdjust=
...
a.parentNode;this.Easing=k;this.el.originalWidth=this.getWidth();this._initSettings();this._checkWidth();this.scrollbar=new z(this);a.className+=a.className?" fixnel-body":"fixnel-body";a.addEventListener(p,i(this._down,this),false);a.addEventListener(p,i(this._stop,this),false);n.addEventListener(B,i(this._up,this),false);n.addEventListener(A,i(this._move,this),false);x.addEventListener("resize",i(this.update,this),false)},moveTo:function(a,b){var c=this,d,e,f;b||(b={});if(a===0||a){a*=-1;if(a>0)a=
0;else if(a<(d=-this._getRight()))a=d;if(b.animOff)return this._setX(a),false;d=this._getX();e=new this.Easing("easeOutExpo",0,d,a-d,10);this._autoMoving=true;(function w(){var b=e.getValue();if(b===null)return e=null,clearTimeout(f),c._setX(a),c._autoMoving=false,null;c._setX(b);f=setTimeout(w,16)})()}},getValue:function(){var a,b,c=0,d=0,d=this.DURATION,e=this.vy;a=0;if(this.bouncing){a=this.bounce.getValue();return a===null?(this._stopScrolling(),null):a|0}a=this._getX();if(C(e)<=0)if(a>0)c=a|
0,this.bounce=new this.Easing("easeOutExpo",0,c,0-c,d),this.bouncing=true;else if(a<(b=-this._getRight()))c=a|0,this.bounce=new this.Easing("easeOutExpo",0,c,b-c,d),this.bouncing=true;else return this._stopScrolling(),null;if(a+e>0)this.vy=e>10?10:e;if(a-e<-this._getRight())this.vy=e<-10?-10:e;return a=a+this.getVX()|0},_initSettings:function(){this.el.style.webkitTextSizeAdjust="none";this.el.style.textSizeAdjust="none"},_checkWidth:function(){var a=this.getParentWidth();this.getOriginalWidth()<
a?this._setWidth(a):this._setWidth("auto")},_checkOverflow:function(){-this._getRight()>this._getX()&&this._setX(-(this.getWidth()-this.getParentWidth()))},_scrolling:function(){var a=this;a.moving=true;clearInterval(a.timer);a.timer=setInterval(function(){var b=a.getValue();if(b===null)return a._stopScrolling(),false;a._setX(b)},this.FPS)},_stopScrolling:function(){this.vy=0;clearInterval(this.timer);this.bouncing=this.moving=false;this.bounce=null;this.trigger("moveend")},_stop:function(){var a=
this;this.stopTimer=setTimeout(function(){clearInterval(a.timer);a.timer=null},100)},_getRight:function(){return this.getWidth()-this.getParentWidth()},getVX:function(){var a=this.vy;this.vy=this.vy-this.vy/30<<0;return a},_setWidth:function(a){if(a){if(Object.prototype.toString.call(a)==="[object String]"){this.el.style.height=a;return}}else return false;this.el.style.height=a+"px"},_getX:function(){return this.x},_setX:function(a){var b=(new WebKitCSSMatrix(this.el.style.webkitTransform)).f;this.x=
...
(e/2|0);this._setX(g);this.prevT=c;this.prevX=a;this.prevAccX=f},_up:function(){if(!this.dragging)return true;this.dragging=false;this._scrolling()},update:function(){this._checkWidth();this._checkOverflow();this.trigger("update")}});E.Fixnel=m})(this,document,this);
